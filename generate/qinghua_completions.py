...
def init_game_plot():
    response = zhipuai.model_api.sse_invoke(
        ...
        prompt="1、我希望你扮演一个基于文本的冒险游戏（游戏主题：王子拯救白雪公主的故事，主角：勇者人杰）；"
               ...
               "7、故事的8个情节结构分别是故事的开端、情节推进、矛盾产生、关键决策、情节发展、高潮冲突、结局逼近、最终结局，8个情节按此顺序逐层递进；"
               "8、你给我的情节需要有趣好玩，适合儿童阅读，前后逻辑有联系；"
               "9、你返回给我的内容包含如下：1）round：是整数，从1开始递增，如果“换一换”则保持不变；2）chapter：枚举值：分别是故事的开端、"
               ...
               "11、注意，请严格按照下面示例的格式，内容请按照上述1-10点要求创作，示例："
